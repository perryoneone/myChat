...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
         ...
         * 最小化窗口点击事件
         */
        minimizeWindow.setOnAction(event -> primaryStage.setIconified(true));
        ...
        tabPane.setPrefSize(360,40);
        tabPane.setTabClosingPolicy(TabPane.TabClosingPolicy.UNAVAILABLE);
        tabPane.setStyle("-fx-background-color: #999");
        ...
        root.getChildren().addAll(stack,tabPane);
